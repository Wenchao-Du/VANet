#PyTorch lib
"""@ define the discriminator with injected attention map
"""
import torch
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(1, 8, 5, 1, 2), nn.ReLU())
        ...
        self.conv_mask = nn.Sequential(nn.Conv2d(128, 1, 5, 1, 2), nn.ReLU())
        self.conv7 = nn.Sequential(nn.Conv2d(128, 64, 5, 4, 1), nn.ReLU())
        self.conv8 = nn.Sequential(nn.Conv2d(64, 64, 5, 4, 1), nn.ReLU())
        self.conv9 = nn.Sequential(nn.Conv2d(64, 32, 5, 4, 1), nn.ReLU())
        self.fc = nn.Sequential(nn.Linear(32 * 1 * 1, 1024),
